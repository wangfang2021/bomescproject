...
namespace Common
{
    ...
    public class ComConnectionHelper
    {
        ...
        public static string GetConnectionString_MainToUnit(string strUnitCode)
        {
            ...
            {
                case "TFTM":
                    return "Persist Security Info = False; User ID = sa; Password = SPPS_Server2019; Initial Catalog = SPPSdb_0331_hj; Data Source =172.23.180.116";
                case "SFTM":
                ...
                case "TK":
                    ...
                    return "Persist Security Info = False; User ID = sa; Password = SPPS_Server2019; Initial Catalog = SPPSdb_TK_0331_hj; Data Source =172.23.180.115";
                default:
                    return "Persist Security Info = False; User ID = sa; Password = Sa123; Initial Catalog = xxx; Data Source =xxx";
            }
            //switch (strUnitCode)
