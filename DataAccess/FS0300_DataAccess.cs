    ...
    public class FS0300_DataAccess
    {
        ...
        public DataTable getList(string PartId, string Supplier_id)
        {
            try
            {
                ...
                sbr.AppendLine("                    FROM SPPSdb.dbo.TSPMaster");
                ...
                sbr.AppendLine("                             FROM SPPSdb.dbo.TSPMaster_SupplierPlant");
                ...
                sbr.AppendLine("                             FROM SPPSdb.dbo.TSPMaster_SufferIn");
                ...
                sbr.AppendLine("                             FROM SPPSdb.dbo.TSPMaster_Box");
                ...
                sbr.AppendLine("                             FROM SPPSdb.dbo.TPackageMaster");
                ...
                sbr.AppendLine("                             FROM SPPSdb.dbo.TPackItem");
