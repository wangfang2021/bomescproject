    ...
    public class FS0301_DataAccess
    {
        ...
        public DataTable getList(string iState, string dOperatorTime)
        {
            try
            {
                ...
                sbr.Append(" SELECT iAutoId,'0' as vcModFlag,'0' as vcAddFlag,vcFileNameTJ,case vcState WHEN 0 THEN '未开封' WHEN 1 THEN '已开封' WHEN 2 THEN '已完成' END AS State ,vcRemark,dUploadTime,Convert(varchar(10),dUploadTime,111) as dUploadTime1 FROM TSBFile \r\n");
