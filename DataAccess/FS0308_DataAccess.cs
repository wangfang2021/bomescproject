    ...
    public class FS0308_DataAccess
    {
        ...
        public DataTable searchApi(string strYear, string Receiver)
        {
            try
            {
                ...
                sbr.Append(" SELECT a.iAuto_id,'0' AS selected,'0' as vcModFlag,'0' as vcAddFlag,a.vcYear,b.vcName AS vcFinish,a.dFinishYMD,Convert(varchar(10),a.dFinishYMD,111) as dFinishYMD1,a.vcSYTCode AS vcSYTCode,a.vcReceiver AS vcReceiver,a.vcOriginCompany AS vcOriginCompany,   \r\n");
                ...
                sbr.Append(" LEFT JOIN (SELECT vcName,vcValue FROM TCode WHERE vcCodeId = 'C066') b ON a.vcFinish = b.vcValue \r\n");
