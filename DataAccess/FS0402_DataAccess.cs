    ...
    public class FS0402_DataAccess
    {
            ...
            ref List<string> errMessageList,string strUnit)
        {
            try
            {
                ...
                sql.Append("    select a.vcPart_id from    \r\n ");
                sql.Append("    (    \r\n ");
                sql.Append("       select * from TSoq_temp where vcYearMonth='" + strYearMonth + "' and iCbSOQN<>0    \r\n ");
                sql.Append("    )a    \r\n ");
                ...
                sql.Append("    select a.vcPart_id from    \r\n ");
                sql.Append("    (    \r\n ");
                sql.Append("       select * from TSoq_temp where vcYearMonth='" + strYearMonth + "' and iCbSOQN1<>0   \r\n ");
                sql.Append("    )a    \r\n ");
                sql.Append("    inner join      \r\n ");
                sql.Append("    (      \r\n ");
                ...
                sql.Append("    select a.vcPart_id from    \r\n ");
                sql.Append("    (    \r\n ");
                sql.Append("       select * from TSoq_temp where vcYearMonth='" + strYearMonth + "' and iCbSOQN2<>0    \r\n ");
                sql.Append("    )a    \r\n ");
                sql.Append("    inner join      \r\n ");
                sql.Append("    (      \r\n ");
                ...
                sql.Append("from (    \n");
                sql.Append("	select * from TSoq_temp where vcYearMonth='" + strYearMonth + "' and (iCbSOQN<>0 or iCbSOQN1<>0 or iCbSOQN2<>0)    \n");
                sql.Append(")t1        \n");
                sql.Append("left join (    \n");
                sql.Append("	select vcPartId,vcCarfamilyCode,vcHaoJiu,vcReceiver,vcPackingPlant,vcSupplierId,vcInOut    \n");
                sql.Append("	from TSPMaster     \n");
