    ...
    public class FS0501_DataAccess
    {
        ...
        public DataTable Search(string strYearMonth, string strSupplier_id, string strPart_id, string strDyState, string strOperState)
        {
            try
            {
                ...
                strSql.Append(" end as vcBgColor,'0' as vcModFlag,'0' as vcAddFlag      \n");
                strSql.Append("from(    \n");
            ...
            ref List<string> errMessageList, string strUnit)
        {
            try
            {
                ...
                for (int i = 0; i < listInfoData.Count; i++)
                {
                    ...
                    {//修改
                        sql.Append("  INSERT INTO TSoq_temp(vcYearMonth,vcPart_id,iTzhSOQN,iTzhSOQN1,iTzhSOQN2,vcOperator,dOperatorTime) values  ");
        ...
        public void importSave(string strYearMonth, string strUserId, string strUnit)
        {
            try
            {
                ...
                //更新调整后字段
                sql.Append("update t2 set t2.iTzhSOQN=t1.iTzhSOQN,t2.iTzhSOQN1=t1.iTzhSOQN1,t2.iTzhSOQN2=t1.iCbSOQN2,    \n");
