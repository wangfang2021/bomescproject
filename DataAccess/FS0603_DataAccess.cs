    ...
    public class FS0603_DataAccess
    {
        ...
        public DataSet getSyncInfo()
        {
            try
            {
                ...
                strSql_insert.AppendLine("           ,[vcPackingPlant]");
                strSql_insert.AppendLine("           ,[vcPartId]");
                strSql_insert.AppendLine("           ,[vcPartENName]");
                strSql_insert.AppendLine("           ,[vcCarfamilyCode]");
                strSql_insert.AppendLine("           ,[vcCarModel]");
                strSql_insert.AppendLine("           ,[vcReceiver]");
                strSql_insert.AppendLine("           ,[dFromTime]");
                strSql_insert.AppendLine("           ,[dToTime]");
                strSql_insert.AppendLine("           ,[vcPartId_Replace]");
                strSql_insert.AppendLine("           ,[vcInOut]");
                strSql_insert.AppendLine("           ,[vcOESP]");
                strSql_insert.AppendLine("           ,[vcHaoJiu]");
                strSql_insert.AppendLine("           ,[vcOldProduction]");
                strSql_insert.AppendLine("           ,[dOldStartTime]");
                strSql_insert.AppendLine("           ,[dDebugTime]");
                strSql_insert.AppendLine("           ,[vcSupplierId]");
                strSql_insert.AppendLine("           ,[dSupplierFromTime]");
                strSql_insert.AppendLine("           ,[dSupplierToTime]");
                strSql_insert.AppendLine("           ,[vcSupplierName]");
                strSql_insert.AppendLine("           ,[vcSupplierPlace]");
                strSql_insert.AppendLine("           ,[vcInteriorProject]");
                strSql_insert.AppendLine("           ,[vcPassProject]");
                strSql_insert.AppendLine("           ,[vcFrontProject]");
                strSql_insert.AppendLine("           ,[dFrontProjectTime]");
                strSql_insert.AppendLine("           ,[dShipmentTime]");
                strSql_insert.AppendLine("           ,[vcBillType]");
                strSql_insert.AppendLine("           ,[vcOrderingMethod]");
                strSql_insert.AppendLine("           ,[vcMandOrder]");
                strSql_insert.AppendLine("           ,[vcPartImage]");
                strSql_insert.AppendLine("           ,[vcRemark1]");
                strSql_insert.AppendLine("           ,[vcRemark2]");
                strSql_insert.AppendLine("           ,[vcSupplierPacking]");
                strSql_insert.AppendLine("           ,[vcDelete]");
                strSql_insert.AppendLine("           ,[vcOperatorID]");
                strSql_insert.AppendLine("           ,[dOperatorTime]");
                strSql_insert.AppendLine("           ,[dSyncToSPTime]");
                strSql_insert.AppendLine("           ,[vcPartNameCn]");
                strSql_insert.AppendLine("		   ,[dInSPMasterTime])");
                strSql_insert.AppendLine("SELECT [dSyncTime]");
                strSql_insert.AppendLine("      ,[vcChanges]");
                strSql_insert.AppendLine("      ,[vcPackingPlant]");
                strSql_insert.AppendLine("      ,[vcPartId]");
                strSql_insert.AppendLine("      ,[vcPartENName]");
                ...
                #region 查询同步消息
                strSql_select.AppendLine("select convert(varchar(10),dSyncTime,111) as dSyncTime,");
                strSql_select.AppendLine("		count(*) as iCount,");
                strSql_select.AppendLine("		'同步原单位情报'+cast(count(*) as varchar(10))+'条' as vcSyncMessage ,");
                strSql_select.AppendLine("		'*' as vcChanges,");
                strSql_select.AppendLine("		'0' as bModFlag,");
                strSql_select.AppendLine("		'0' as bAddFlag,");
                strSql_select.AppendLine("		'1' as bSelectFlag,");
                strSql_select.AppendLine("		'' as vcBgColor,");
                strSql_select.AppendLine("		convert(varchar(10),dSyncTime,111) as children");
                strSql_select.AppendLine("from TSPMaster where dSyncToSPTime is not null");
                strSql_select.AppendLine("group by convert(varchar(10),dSyncTime,111)");
                strSql_select.AppendLine("order by dSyncTime");
                strSql_select.AppendLine("select convert(varchar(10),a.dSyncTime,111) as dSyncTime,");
                strSql_select.AppendLine("		count(*) as iCount,");
                strSql_select.AppendLine("		'【'+b.vcName+'】原单位情报'+ cast(count(*) as varchar(10))+'条' as vcSyncMessage ,");
                strSql_select.AppendLine("		b.vcValue as vcChanges,");
                strSql_select.AppendLine("		'0' as bModFlag,");
                strSql_select.AppendLine("		'0' as bAddFlag,");
                strSql_select.AppendLine("		'0' as bSelectFlag,");
                strSql_select.AppendLine("		'' as vcBgColor,");
                strSql_select.AppendLine("		convert(varchar(10),a.dSyncTime,111) as children from");
                strSql_select.AppendLine("(select convert(varchar(10),dSyncTime,111) as dSyncTime,vcChanges from TSPMaster where dSyncToSPTime is not null)a");
                strSql_select.AppendLine("LEFT JOIN");
                strSql_select.AppendLine("(SELECT * FROM TCode WHERE vcCodeId='C002')b");
                strSql_select.AppendLine("ON a.vcChanges=b.vcValue");
                strSql_select.AppendLine("group by convert(varchar(10),a.dSyncTime,111),b.vcName,b.vcValue");
                strSql_select.AppendLine("order by a.dSyncTime,b.vcValue");
                DataSet dataSet = excute.ExcuteSqlWithSelectToDS(strSql_select.ToString());
                #endregion 
                return dataSet;
            }
            catch (Exception ex)
