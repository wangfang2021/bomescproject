    ...
    public class FS0610_DataAccess
    {
        ...
        public DataTable search(string strYearMonth, string strYearMonth_2, string strYearMonth_3,List<string> plantList)
        {
            try
            {
                ...
                strSql.AppendLine("   iD1*iQuantityPercontainer as iD1,");
                strSql.AppendLine("   iD2*iQuantityPercontainer as iD2,");
                strSql.AppendLine("   iD3*iQuantityPercontainer as iD3,");
                strSql.AppendLine("   iD4*iQuantityPercontainer as iD4,");
                strSql.AppendLine("   iD5*iQuantityPercontainer as iD5,");
                strSql.AppendLine("   iD6*iQuantityPercontainer as iD6,");
                strSql.AppendLine("   iD7*iQuantityPercontainer as iD7,");
                strSql.AppendLine("   iD8*iQuantityPercontainer as iD8,");
                strSql.AppendLine("   iD9*iQuantityPercontainer as iD9,");
                strSql.AppendLine("   iD10*iQuantityPercontainer as iD10,");
                strSql.AppendLine("   iD11*iQuantityPercontainer as iD11,");
                strSql.AppendLine("   iD12*iQuantityPercontainer as iD12,");
                strSql.AppendLine("   iD13*iQuantityPercontainer as iD13,");
                strSql.AppendLine("   iD14*iQuantityPercontainer as iD14,");
                strSql.AppendLine("   iD15*iQuantityPercontainer as iD15,");
                strSql.AppendLine("   iD16*iQuantityPercontainer as iD16,");
                strSql.AppendLine("   iD17*iQuantityPercontainer as iD17,");
                strSql.AppendLine("   iD18*iQuantityPercontainer as iD18,");
                strSql.AppendLine("   iD19*iQuantityPercontainer as iD19,");
                strSql.AppendLine("   iD20*iQuantityPercontainer as iD20,");
                strSql.AppendLine("   iD21*iQuantityPercontainer as iD21,");
                strSql.AppendLine("   iD22*iQuantityPercontainer as iD22,");
                strSql.AppendLine("   iD23*iQuantityPercontainer as iD23,");
                strSql.AppendLine("   iD24*iQuantityPercontainer as iD24,");
                strSql.AppendLine("   iD25*iQuantityPercontainer as iD25,");
                strSql.AppendLine("   iD26*iQuantityPercontainer as iD26,");
                strSql.AppendLine("   iD27*iQuantityPercontainer as iD27,");
                strSql.AppendLine("   iD28*iQuantityPercontainer as iD28,");
                strSql.AppendLine("   iD29*iQuantityPercontainer as iD29,");
                strSql.AppendLine("   iD30*iQuantityPercontainer as iD30,");
                strSql.AppendLine("   iD31*iQuantityPercontainer as iD31,");
