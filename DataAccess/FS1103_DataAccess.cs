    ...
    public class FS1103_DataAccess
    {
        ...
        public DataTable getPartInfo(string strPartId)
        {
            try
            {
                ...
                //strSql.AppendLine("		,'*'+a.vcPartId+SUBSTRING(convert(varchar(100), GETDATE(), 112)+ replace(CONVERT(varchar(5), GETDATE(), 108),':',''),3,10)+'B'+'*' as vcLabel");
                //strSql.AppendLine("		,'*'+a.vcPartId+SUBSTRING(convert(varchar(100), GETDATE(), 112)+ replace(CONVERT(varchar(5), GETDATE(), 108),':',''),3,10)+'B'+'*' as vcLabel1");
                strSql.AppendLine("		,'*'+a.vcPartId+SUBSTRING(convert(varchar(100), GETDATE(), 112),3,6) as vcLabel--后续追加4位顺番(0001--9999)+B*");
                strSql.AppendLine("		,'*'+a.vcPartId+SUBSTRING(convert(varchar(100), GETDATE(), 112),3,6) as vcLabel1--后续追加4位顺番(0001--9999)+B*");
                ...
                //strSql.AppendLine("		,'"+strUrl+"'+a.vcPartId+SUBSTRING(convert(varchar(100), GETDATE(), 112)+ replace(CONVERT(varchar(5), GETDATE(), 108),':',''),3,10)+'B' as vcQrcodeString1");
                strSql.AppendLine("		,'" + strUrl + "'+a.vcPartId+SUBSTRING(convert(varchar(100), GETDATE(), 112),3,6) as vcQrcodeString1--后续追加4位顺番(0001--9999)+B");
                strSql.AppendLine("		,null as iQrcode");
                strSql.AppendLine("		,null as iQrcode1");
                //strSql.AppendLine("		,SUBSTRING(convert(varchar(100), GETDATE(), 112)+ replace(CONVERT(varchar(5), GETDATE(), 108),':',''),3,10)+'B' as vcPrintcount");
                //strSql.AppendLine("		,SUBSTRING(convert(varchar(100), GETDATE(), 112)+ replace(CONVERT(varchar(5), GETDATE(), 108),':',''),3,10)+'B' as vcPrintcount1");
                strSql.AppendLine("		,SUBSTRING(convert(varchar(100), GETDATE(), 112),3,6) as vcPrintcount--后续追加4位顺番(0001--9999)+B");
                strSql.AppendLine("		,SUBSTRING(convert(varchar(100), GETDATE(), 112),3,6) as vcPrintcount1--后续追加4位顺番(0001--9999)+B");
