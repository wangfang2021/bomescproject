  ...
  public class P00004_DataAccess
  {
        ...
        string strIP, string strSellno, string strDock, string strOperId, string strPrinterName)
    {
      ...
      try
      {
        ...
        //modified by laowu
        strSql_add_sl.AppendLine("           ,[vcPartsnamechn])");
        ...
        //modified by laowu
        sqlCommand_add_sl.Parameters.AddWithValue("@vcPartsnamechn", "");
        #endregion
        foreach (DataRow item in dtSell_Temp.Rows)
        {
          ...
          //modified by laowu
          sqlCommand_add_sl.Parameters["@vcPartsnamechn"].Value = item["vcPartsnamechn"].ToString();
          #endregion
