    ...
    public class FS0406_Logic
    {
        ...
        public void sendMail(List<Dictionary<string, Object>> listInfoData, string strUserId, string strUserName, ref string refMsg, string Email, string unit, string unitCode)
        {
            try
            {
                ...
                //sbr.AppendLine("<p><strong style=\"color: black;\">" + unitCode + " " + range + "&nbsp;对帐数据&nbsp;</strong><strong style=\"color: black;\">&nbsp;<u>月度对帐数</u></strong><strong style=\"color: black;\"><u>据</u></strong><strong style=\"color: black;\"><u>&nbsp;" + total + "</u></strong><strong style=\"color: black;\"><u>元&nbsp;&nbsp;</u></strong><strong><u>，请</u></strong><strong style=\"color: black;\"><u>确认</u></strong><strong><u>。</u></strong></p><p class=\"ql-align-justify\"><strong>&nbsp;</strong></p>");
                sbr.AppendLine("<p><strong style=\"color: black;\">" + unitCode + " " + range + "&nbsp;对帐数据&nbsp;</strong><strong style=\"color: black;\">&nbsp;<u>月度对帐数</u></strong><strong style=\"color: black;\"><u>据</u></strong><strong style=\"color: blue;\"><u>&nbsp;" + total + "</u></strong><strong style=\"color: blue;\"><u>元&nbsp;&nbsp;</u></strong><strong><u>，请</u></strong><strong style=\"color: black;\"><u>确认</u></strong><strong><u>。</u></strong></p><p class=\"ql-align-justify\"><strong>&nbsp;</strong></p>");
