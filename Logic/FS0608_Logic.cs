...
namespace Logic
{
    public class FS0608_Logic
    {
        ...
        public JObject Search(DateTime varDxny, string varFZGC)
        {
            ...
            DataTable re = fs0608_DataAccess.SearchData(varDxny, varFZGC);
            DataTable re1 = fs0608_DataAccess.SearchData(varDxny.AddMonths(1), varFZGC);
            DataTable re2 = fs0608_DataAccess.SearchData(varDxny.AddMonths(2), varFZGC);
        ...
        public string save(List<string> dayTypeVals, List<string> weekTypeVals, string varDxny, string varFZGC, decimal TOTALWORKDAYS, string strUserId)
        {
            ...
            return fs0608_DataAccess.save(re, varDxny, varFZGC, TOTALWORKDAYS, strUserId);
        }
