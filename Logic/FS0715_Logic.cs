...
namespace Logic
{
    public class FS0715_Logic
    {
        ...
        {
            return FS0715_DataAccess.getSupplier();
        }
        #endregion
        ...
        {
            return FS0715_DataAccess.Search_GS(strBegin, strEnd );
        }
        #endregion
        ...
        {
            FS0715_DataAccess.Save_GS(listInfoData, strUserId, ref strErrorName);
        }
        #endregion
