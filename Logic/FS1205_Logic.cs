    ...
    public class FS1205_Logic
    {
        ...
        public string btnExport(DataTable dt, ref string exlName)
        {
            try
            {
                ...
                exlName = Month + "-" + Week + "_平准化确认文件" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
                return "";
            }
            catch
            {
        ...
        {
            StringBuilder strSQL = new StringBuilder();
            strSQL.AppendLine("select vcMonth, vcWeek, vcPlant, vcGC, vcZB, vcPartsno, vcQuantityPerContainer, vcD1b, vcD1y, vcD2b, vcD2y, vcD3b, vcD3y, vcD4b, " +
                "vcD4y, vcD5b, vcD5y, vcD6b, vcD6y, vcD7b, vcD7y, vcD8b, vcD8y, vcD9b, vcD9y, vcD10b, vcD10y, vcD11b, vcD11y, vcD12b, vcD12y, vcD13b, vcD13y, vcD14b, " +
                "vcD14y, vcD15b, vcD15y, vcD16b, vcD16y, vcD17b, vcD17y, vcD18b, vcD18y, vcD19b, vcD19y, vcD20b, vcD20y, vcD21b, vcD21y, vcD22b, vcD22y, vcD23b, vcD23y, " +
                "vcD24b, vcD24y, vcD25b, vcD25y, vcD26b, vcD26y, vcD27b, vcD27y, vcD28b, vcD28y, vcD29b, vcD29y, vcD30b, vcD30y, vcD31b, vcD31y, vcWeekTotal, vcLevelD1b, " +
                "vcLevelD1y, vcLevelD2b, vcLevelD2y, vcLevelD3b, vcLevelD3y, vcLevelD4b, vcLevelD4y, vcLevelD5b, vcLevelD5y, vcLevelD6b, vcLevelD6y, vcLevelD7b, vcLevelD7y, " +
                "vcLevelD8b, vcLevelD8y, vcLevelD9b, vcLevelD9y, vcLevelD10b, vcLevelD10y, vcLevelD11b, vcLevelD11y, vcLevelD12b, vcLevelD12y, vcLevelD13b, vcLevelD13y, " +
                "vcLevelD14b, vcLevelD14y, vcLevelD15b, vcLevelD15y, vcLevelD16b, vcLevelD16y, vcLevelD17b, vcLevelD17y, vcLevelD18b, vcLevelD18y, vcLevelD19b, vcLevelD19y, " +
                "vcLevelD20b, vcLevelD20y, vcLevelD21b, vcLevelD21y, vcLevelD22b, vcLevelD22y, vcLevelD23b, vcLevelD23y, vcLevelD24b, vcLevelD24y, vcLevelD25b, vcLevelD25y, " +
                ...
                "vcLevelWeekTotal from WeekLevelSchedule where 1=2");//这样一定不会搜到数据，一定是行数为0的表
        ...
        public string TXTScheduleToPlan(DataTable dt, string strMonth, string strWeek, string strPlant, string strUser)
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                if (dtTMP4.Rows.Count <= 0)
                {
                    ...
                    dr["CUPDUSER"] = strUser;
                    dr["vcSupplier_id"] = dtTMPMonthPackPlan.Rows[0]["vcSupplier_id"];
                    for (int k = 0; k < _iWeekDays; k++)
                    {
        ...
        {
            return fs0610_DataAccess.getDockTable(TargetYM);
        }
    }
}