    ...
    public class FS1704_Logic
    {
        ...
        public DataTable getTCode(string strCodeId)
        {
            try
            {
                ...
                return fs1704_DataAccess.getTCode(strCodeId);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        {
            return fs1704_DataAccess.Search_PM(smallpm, bigpm);
        }
        #endregion
        ...
        {
            fs1704_DataAccess.Save_pm(listInfoData, strUserId);
        }
        #endregion
        ...
        {
            fs1704_DataAccess.Del_pm(checkedInfoData, strUserId);
        }
        #endregion
        ...
        {
            return fs1704_DataAccess.Search_StandardTime(bigpm, standardtime);
        }
        #endregion
        ...
        {
            fs1704_DataAccess.Save_Standardtime(listInfoData, strUserId);
        }
        #endregion
        ...
        {
            fs1704_DataAccess.Del_Standardtime(checkedInfoData, strUserId);
        }
        #endregion
        ...
        {
            int num = fs1704_DataAccess.RepeatCheck(vcSR, vcPartsNoBefore5, vcBCPartsNo);
            if (num > 0)
            {
                return true;
            }
        ...
        {
            int num = fs1704_DataAccess.RepeatCheckSmall(vcSmallPM, strMode, strAutoId);
            if (num > 0)
            {
                return true;
            }
        ...
        {
            fs1704_DataAccess.importSave(dt, strUserId);
        }
        #endregion
        ...
        {
            int num = fs1704_DataAccess.RepeatCheckStandardTime(vcBigPM);
            if (num > 0)
            {
                return true;
            }
        ...
        {
            fs1704_DataAccess.importSave_StandardTime(dt, strUserId);
        }
        #endregion
