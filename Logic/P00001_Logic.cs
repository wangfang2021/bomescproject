...
namespace Logic
{
    public class P00001_Logic
    {
      ...
      itemname10, packLocation10, suppName10, outNum10, partsAndNum, cpdCompany, opearteId, scanTime, vs1);
        ...
        public static DataSet CheckDb(string partId, string kanbanOrderNo, string kanbanSerial, string dock, string scanTime)
        {
            return P00001_DataAccess.CheckDb(partId, kanbanOrderNo, kanbanSerial, dock, scanTime);
        }
        ...
        public static bool setInputInfo(string strIP, string strPointName, DataTable dtPackList_Temp, DataTable dtLabelList_Temp, DataTable dtInv_Temp, DataTable dtOrder_Temp, string strOperId)
        {
