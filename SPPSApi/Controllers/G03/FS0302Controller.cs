    ...
    public class FS0302Controller : BaseController
    {
        ...
        public string exportApi([FromBody] dynamic data)
        {
            ...
            try
            {
                ...
                string resMsg = "";
                string[] fields = { "vcSPINo", "vcPart_Id_old", "vcPart_Id_new", "FinishState", "vcUnit", "vcDiff", "vcCarType", "THChange", "vcDD", "vcRemark", "vcChange", "vcBJDiff", "vcDT", "vcPartName", "vcStartYearMonth", "vcFXDiff", "vcFXNo", "vcOldProj", "dOldProjTime1", "vcNewProj", "dNewProjTime1", "vcCZYD", "dHandleTime1", "vcNum" };
