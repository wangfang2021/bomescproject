    ...
    public class FS0308Controller : BaseController
    {
        ...
        public string exportApi([FromBody] dynamic data)
        {
            ...
            try
            {
                ...
                string[] fields = { "vcYear", "vcFinish", "dFinishYMD", "vcPart_id", "vcPartNameEn", "vcInOutflag", "vcCarTypeDev", "dJiuBegin", "vcRemark", "vcOld10", "vcOld9", "vcOld7", "vcPM", "vcNum1", "vcNum2", "vcNum3", "vcNXQF", "dSSDate", "vcDY", "vcNum11", "vcNum12", "vcNum13", "vcNum14", "vcNum15", "vcNum16", "vcNum17", "vcNum18", "vcNum19", "vcNum20", "vcNum21", "vcSYTCode", "vcReceiver", "vcOriginCompany" };
