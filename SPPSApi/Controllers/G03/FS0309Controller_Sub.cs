...
{
    [Route("api/FS0309_Sub/[action]")]
    [EnableCors("any")]
    [ApiController]
    public class FS0309Controller_Sub : BaseController
    {
        ...
        public FS0309Controller_Sub(IWebHostEnvironment webHostEnvironment)
        {
        ...
        public string pageloadApi()
        {
            ...
            try
            {
                ...
                List<Object> dataList_C038 = ComFunction.convertAllToResult(ComFunction.getTCode("C038"));//公式
        ...
        public string searchApi([FromBody] dynamic data)
        {
            ...
            try
            {
                DataTable dt = fs0309_Logic.Search_GS(strBegin, strEnd);
                DtConverter dtConverter = new DtConverter();
                dtConverter.addField("vcModFlag", ConvertFieldType.BoolType, null);
                dtConverter.addField("vcAddFlag", ConvertFieldType.BoolType, null);
                dtConverter.addField("dBegin", ConvertFieldType.DateType, "yyyy-MM-dd");
                dtConverter.addField("dEnd", ConvertFieldType.DateType, "yyyy-MM-dd");
            ...
            {
                ComMessage.GetInstance().ProcessMessage(FunctionID, "M03UE0907", ex, loginInfo.UserId);
                apiResult.code = ComConstant.ERROR_CODE;
                apiResult.data = "检索公式失败";
                return JsonConvert.SerializeObject(apiResult, Formatting.Indented, JSON_SETTING);
            }
        }
        #endregion
            ...
            try
            {
                ...
                if (hasFind)
                {
                    string[,] strField = new string[,] {{"公式名","系数","税率","适用范围","开始时间","结束时间","变更原因描述"},
                                                {"vcGSName","decXiShu","decTaxRate","vcArea","dBegin","dEnd","vcReason"},
                ...
                string strErrorName = "";
                fs0309_Logic.Save_GS(listInfoData, loginInfo.UserId,ref strErrorName);
                if (strErrorName != "")
                {
                    apiResult.code = ComConstant.ERROR_CODE;
                    apiResult.data = "保存失败，以下公式开始时间、结束时间区间存在重叠：<br/>"+ strErrorName;
        ...
        public string delApi([FromBody]dynamic data)
        {
            ...
            try
            {
                ...
                fs0309_Logic.Del_GS(listInfoData, loginInfo.UserId);
                apiResult.code = ComConstant.SUCCESS_CODE;
                apiResult.data = null;
                return JsonConvert.SerializeObject(apiResult, Formatting.Indented, JSON_SETTING);
            }
