        ...
        public string importSaveApi([FromBody] dynamic data)
        {
            ...
            try
            {
                ...
                string[,] headers = new string[,] {{"品番"     ,"号旧"    ,"旧型开始时间" ,"供应商代码"   ,"供应商名称"     ,"车型(开发代码)" ,"品名"      ,"旧型1年"     ,"旧型2年"     ,"旧型3年"     ,"旧型4年"     ,"旧型5年"     ,"旧型6年"     ,"旧型7年"     ,"旧型8年"     ,"旧型9年"     ,"旧型10年"     ,"送信时间"     },
                                                   ...
                                                   {""         ,""        ,FieldCheck.Date,""             ,"100"            ,""               ,""          ,FieldCheck.Num,FieldCheck.Num,FieldCheck.Num,FieldCheck.Num,FieldCheck.Num,FieldCheck.Num,FieldCheck.Num,FieldCheck.Num,FieldCheck.Num,FieldCheck.Num ,FieldCheck.Date},
                                                   {"14"       ,"0"       ,"0"            ,"4"            ,"100"             ,"4"             , "100"      ,"10"          ,"10"          ,"10"          ,"10"          ,"10"          ,"10"          ,"10"          ,"10"          ,"10"          ,"10"           ,"10"           },//最大长度设定,不校验最大长度用0
            ...
            {
                ComFunction.DeleteFolder(fileSavePath);//读取异常则，删除文件夹，全部重新上传
                ComMessage.GetInstance().ProcessMessage(FunctionID, "M03UE1205", ex, loginInfo.UserId);
                apiResult.code = ComConstant.ERROR_CODE;
