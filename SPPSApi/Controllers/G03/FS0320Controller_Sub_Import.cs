...
{
    [Route("api/FS0320_Sub_Import/[action]")]
    [EnableCors("any")]
    [ApiController]
    public class FS0320Controller_Sub_Import : BaseController
    {
        ...
        public FS0320Controller_Sub_Import(IWebHostEnvironment webHostEnvironment)
        {
