...
namespace SPPSApi.Controllers.G04
{
    ...
    public class FS0404Controller : BaseController
    {
        ...
        public string updateOKApi([FromBody] dynamic data)
        {
            ...
            {
                ComMessage.GetInstance().ProcessMessage(FunctionID, "M04UE0405", ex, loginInfo.UserId);
                apiResult.code = ComConstant.ERROR_CODE;
                apiResult.data = "修正订单失败！";
                return JsonConvert.SerializeObject(apiResult, Formatting.Indented, JSON_SETTING);
            }
        }
        #endregion
        ...
        public string exportmessageApi([FromBody] dynamic data)
        {
            ...
            {
                ComMessage.GetInstance().ProcessMessage(FunctionID, "M04UE0406", ex, loginInfo.UserId);
                apiResult.code = ComConstant.ERROR_CODE;
