    ...
    public class FS0605Controller : BaseController
    {
        ...
        public string exportApi([FromBody] dynamic data)
        {
            ...
            try
            {
                ...
                string filepath = ComFunction.generateExcelWithXlt(dt, field, _webHostEnvironment.ContentRootPath, "FS0605_Data.xlsx", 1, loginInfo.UserId, FunctionID, true);
                if (filepath == "")
                {
                    apiResult.code = ComConstant.ERROR_CODE;
            ...
            try
            {
                ...
                if (hasFind)
                {
                    string[,] strField = new string[,] {{"供应商代码","工区","生产能力&纳期确认", "联系人1", "电话1","邮箱1", "联系人2", "电话2","邮箱2", "联系人3", "电话3","邮箱3"},
                                                ...
                                                {"","","","","","","","","","","","" },
                                                {"4","50","0","100","100","100","100","100","100","100","100","100"},//最大长度设定,不校验最大长度用0
        ...
        public string deleteApi([FromBody] dynamic data)
        {
            ...
            {
                ComMessage.GetInstance().ProcessMessage(FunctionID, "M06UE0506", ex, loginInfo.UserId);
                apiResult.code = ComConstant.ERROR_CODE;
                apiResult.data = "删除失败";
                return JsonConvert.SerializeObject(apiResult, Formatting.Indented, JSON_SETTING);
            }
