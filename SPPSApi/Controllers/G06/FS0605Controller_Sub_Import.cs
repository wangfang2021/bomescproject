...
{
    [Route("api/FS0605_Sub_Import/[action]")]
    [EnableCors("any")]
    [ApiController]
    public class FS0605Controller_Sub_Import : BaseController
    {
        ...
        public FS0605Controller_Sub_Import(IWebHostEnvironment webHostEnvironment)
        {
        ...
        public string importSaveApi([FromBody]dynamic data)
        {
            ...
            try
            {
                ...
                string strMsg = "";
                string[,] headers = new string[,] {{"供应商代码","工区","能力确认", "联系人1", "电话1","邮箱1", "联系人2", "电话2","邮箱2", "联系人3", "电话3","邮箱3"},
                ...
                fs0605_Logic.importSave(importDt, loginInfo.UserId);
            ...
            {
                ComFunction.DeleteFolder(fileSavePath);//读取异常则，删除文件夹，全部重新上传
                ComMessage.GetInstance().ProcessMessage(FunctionID, "M06UE0507", ex, loginInfo.UserId);
                apiResult.code = ComConstant.ERROR_CODE;
