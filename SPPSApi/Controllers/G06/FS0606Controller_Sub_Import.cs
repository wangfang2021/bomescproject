...
{
    [Route("api/FS0606_Sub_Import/[action]")]
    [EnableCors("any")]
    [ApiController]
    public class FS0606Controller_Sub_Import : BaseController
    {
        ...
        public FS0606Controller_Sub_Import(IWebHostEnvironment webHostEnvironment)
        {
        ...
        public string importSaveApi([FromBody]dynamic data)
        {
            ...
            try
            {
                ...
                fs0606_Logic.importSave(importDt, loginInfo.UserId);
            ...
            {
                ComFunction.DeleteFolder(fileSavePath);//读取异常则，删除文件夹，全部重新上传
                ComMessage.GetInstance().ProcessMessage(FunctionID, "M06UE0606", ex, loginInfo.UserId);
                apiResult.code = ComConstant.ERROR_CODE;
