    ...
    public class FS0607Controller : BaseController
    {
        ...
        public string searchApi([FromBody] dynamic data)
        {
            ...
            try
            {
                ...
                // iAutoId, vcSupplier_id, vcWorkArea, dBeginDate, dEndDate, vcOperatorID, dOperatorTime
                List<Object> dataList = ComFunction.convertToResult(dt, new string[] { "iAutoId","vcSupplier_id","vcWorkArea", "dBeginDate", "dEndDate", 
                "vcmodflag","vcaddflag"});
        ...
        public string saveApi([FromBody] dynamic data)
        {
            ...
            try
            {
                ...
                if (dtadd.Rows.Count > 0)
                {
                    Boolean isExistAddData = fs0607_Logic.isExistAddData(dtadd);
                    if (isExistAddData)
                    {
                        apiResult.code = ComConstant.ERROR_CODE;
                ...
                fs0607_Logic.Save(dtadd, dtmod, loginInfo.UserId);
                apiResult.code = ComConstant.SUCCESS_CODE;
                apiResult.data = null;
                return JsonConvert.SerializeObject(apiResult, Formatting.Indented, JSON_SETTING);
            }
        ...
        public string deleteApi([FromBody] dynamic data)
        {
            ...
            try
            {
                ...
                fs0607_Logic.Del(dtdel, loginInfo.UserId);
                apiResult.code = ComConstant.SUCCESS_CODE;
                apiResult.data = null;
                return JsonConvert.SerializeObject(apiResult, Formatting.Indented, JSON_SETTING);
            }
        ...
        public string allInstallApi([FromBody] dynamic data)
        {
            ...
            try
            {
                ...
                fs0607_Logic.allInstall (Convert.ToDateTime(dBeginDate), Convert.ToDateTime(dEndDate), loginInfo.UserId);
                apiResult.code = ComConstant.SUCCESS_CODE;
                apiResult.data = null;
                return JsonConvert.SerializeObject(apiResult, Formatting.Indented, JSON_SETTING);
            }
