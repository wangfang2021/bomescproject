...
{
    [Route("api/FS0609/[action]")]
    [EnableCors("any")]
    [ApiController]
    public class FS0609Controller : BaseController
    {
        private readonly IWebHostEnvironment _webHostEnvironment;
        private readonly string FunctionID = "FS0609";
        FS0609_Logic fs0609_Logic = new FS0609_Logic();

        public FS0609Controller(IWebHostEnvironment webHostEnvironment)
        {
        ...
        public string searchApi([FromBody] dynamic data)
        {
            ...
            try
            {
                JObject dt = fs0609_Logic.Search(varDxny, varFZGC);
