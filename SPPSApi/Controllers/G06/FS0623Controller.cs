...
namespace SPPSApi.Controllers.G06
{
    ...
    public class FS0623Controller : BaseController
    {
        ...
        public string searchApi([FromBody] dynamic data)
        {
            ...
            {
                ComMessage.GetInstance().ProcessMessage(FunctionID, "M06UE2301", ex, loginInfo.UserId);
        ...
        public string delApi([FromBody] dynamic data)
        {
            ...
            {
                ComMessage.GetInstance().ProcessMessage(FunctionID, "M06UE2303", ex, loginInfo.UserId);
                apiResult.code = ComConstant.ERROR_CODE;
