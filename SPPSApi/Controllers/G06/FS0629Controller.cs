...
namespace SPPSApi.Controllers.G06
{
    ...
    public class FS0629Controller : BaseController
    {
        ...
        public string bindConsignee()
        {
            ...
            try
            {
                DataTable dt = fs0629_Logic.BindConsignee();
        ...
        public string bindInsideOutsideType()
        {
            ...
            try
            {
                DataTable dt = fs0629_Logic.BindInsideOutsideType();
                List<Object> dataList = ComFunction.convertToResult(dt, new string[] { "vcCodeId", "vcCodeName" });
                apiResult.code = ComConstant.SUCCESS_CODE;
                apiResult.data = dataList;
                return JsonConvert.SerializeObject(apiResult, Formatting.Indented, JSON_SETTING);
        ...
        public string searchApi([FromBody] dynamic data)
        {
            ...
            try
            {
                DataTable dt = fs0629_Logic.Search(vcTargetYear, vcPartNo, vcInjectionFactory, vcInsideOutsideType, vcSupplier_id, vcWorkArea, vcCarType);
