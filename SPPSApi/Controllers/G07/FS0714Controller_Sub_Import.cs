...
{
    [Route("api/FS0714_Sub_Import/[action]")]
    [EnableCors("any")]
    [ApiController]
    public class FS0714Controller_Sub_Import : BaseController
    {
        ...
        public FS0714Controller_Sub_Import(IWebHostEnvironment webHostEnvironment)
        {
        ...
        public string importSaveApi([FromBody] dynamic data)
        {
            ...
            try
            {
                ...
                fs0714_Logic.importSave(importDt, loginInfo.UserId);
