...
{
    [Route("api/FS0715_Sub_BanZhi/[action]")]
    [EnableCors("any")]
    [ApiController]
    public class FS0715_Sub_BanZhiController : BaseController
    {
        private readonly IWebHostEnvironment _webHostEnvironment;

        FS0715_Logic FS0715_Logic = new FS0715_Logic();
        private readonly string FunctionID = "FS0715";
        public FS0715_Sub_BanZhiController(IWebHostEnvironment webHostEnvironment)
        {
        ...
        public string pageloadApi()
        {
            ...
            {
                ComMessage.GetInstance().ProcessMessage(FunctionID, "M07UE1505", ex, loginInfo.UserId);
                apiResult.code = ComConstant.ERROR_CODE;
                apiResult.data = "班值初始化失败";
                return JsonConvert.SerializeObject(apiResult, Formatting.Indented, JSON_SETTING);
            }
        }
        #endregion
        ...
        public string searchApi([FromBody] dynamic data)
        {
            ...
            {
                ComMessage.GetInstance().ProcessMessage(FunctionID, "M07UE1506", ex, loginInfo.UserId);
                apiResult.code = ComConstant.ERROR_CODE;
                apiResult.data = "班值检索失败";
                return JsonConvert.SerializeObject(apiResult, Formatting.Indented, JSON_SETTING);
            }
        }
        #endregion
        ...
        public string exportApi([FromBody] dynamic data)
        {
            ...
            try
            {
                //DataTable dt = FS0715_Sub_BanZhi_Logic.Search();
                DataTable dt = null;
                ...
                string filepath = ComFunction.generateExcelWithXlt(dt, fields, _webHostEnvironment.ContentRootPath, "FS0715_Sub_BanZhi_Export.xlsx", 2,loginInfo.UserId,FunctionID  );
                if (filepath == "")
                {
                    apiResult.code = ComConstant.ERROR_CODE;
            ...
            {
                ComMessage.GetInstance().ProcessMessage(FunctionID, "M07UE1507", ex, loginInfo.UserId);
                apiResult.code = ComConstant.ERROR_CODE;
                apiResult.data = "班值导出失败";
                return JsonConvert.SerializeObject(apiResult, Formatting.Indented, JSON_SETTING);
            }
        }
        #endregion
        ...
        public string saveApi([FromBody]dynamic data)
        {
            ...
            {
                ComMessage.GetInstance().ProcessMessage(FunctionID, "M07UE1508", ex, loginInfo.UserId);
                apiResult.code = ComConstant.ERROR_CODE;
                apiResult.data = "班值保存失败";
                return JsonConvert.SerializeObject(apiResult, Formatting.Indented, JSON_SETTING);
            }
        }
        #endregion
        ...
        public string delApi([FromBody]dynamic data)
        {
            ...
            {
                ComMessage.GetInstance().ProcessMessage(FunctionID, "M07UE1509", ex, loginInfo.UserId);
                apiResult.code = ComConstant.ERROR_CODE;
                apiResult.data = "班值删除失败";
                return JsonConvert.SerializeObject(apiResult, Formatting.Indented, JSON_SETTING);
            }
        }
        #endregion
