...
{
    [Route("api/FS0716/[action]")]
    [EnableCors("any")]
    [ApiController]
    public class FS0716Controller : BaseController
    {
        private readonly IWebHostEnvironment _webHostEnvironment;

        FS0716_Logic FS0716_Logic = new FS0716_Logic();
        private readonly string FunctionID = "FS0716";

        public FS0716Controller(IWebHostEnvironment webHostEnvironment)
        {
        ...
        public string pageloadApi()
        {
            ...
            try
            {
                ...
                List<Object> dataList_Supplier = ComFunction.convertAllToResult(FS0716_Logic.SearchSupplier());//供应商
        ...
        public string searchApi([FromBody] dynamic data)
        {
            ...
            string SupplierID = dataForm.SupplierCode;
      

            try
            {
                DataTable dt = FS0716_Logic.Search(SupplierID);
        ...
        public string exportApi([FromBody] dynamic data)
        {
            ...
            {
                DataTable dt = FS0716_Logic.Search(SupplierID);
                string[] fields = { "vcPackSupplierCode","vcPackSupplierName","vcPerson","vcPhone","vcEmail","vcAddress"
                };
                string filepath = ComFunction.generateExcelWithXlt(dt, fields, _webHostEnvironment.ContentRootPath, "FS0716_Export.xlsx", 2,loginInfo.UserId,FunctionID  );
                if (filepath == "")
                {
                    apiResult.code = ComConstant.ERROR_CODE;
        ...
        public string saveApi([FromBody]dynamic data)
        {
            ...
            try
            {
                ...
                FS0716_Logic.Save(listInfoData, loginInfo.UserId,ref strErrorPartId);
                if (strErrorPartId != "")
                {
                    apiResult.code = ComConstant.ERROR_CODE;
                    apiResult.data = "保存失败";
        ...
        public string delApi([FromBody]dynamic data)
        {
            ...
            try
            {
                ...
                FS0716_Logic.Del(listInfoData, loginInfo.UserId);
                apiResult.code = ComConstant.SUCCESS_CODE;
                apiResult.data = null;
                return JsonConvert.SerializeObject(apiResult, Formatting.Indented, JSON_SETTING);
            }
