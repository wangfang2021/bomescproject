...
{
    [Route("api/FS0810_Sub_PM_Import/[action]")]
    [EnableCors("any")]
    [ApiController]
    public class FS0810Controller_Sub_PM_Import : BaseController
    {
        ...
        public FS0810Controller_Sub_PM_Import(IWebHostEnvironment webHostEnvironment)
        {
        ...
        public string importSaveApi([FromBody]dynamic data)
        {
            ...
            try
            {
                ...
                fs0810_Logic.importSave(importDt, loginInfo.UserId);
            ...
            {
                ComFunction.DeleteFolder(fileSavePath);//读取异常则，删除文件夹，全部重新上传
                ComMessage.GetInstance().ProcessMessage(FunctionID, "M08UE1013", ex, loginInfo.UserId);
                apiResult.code = ComConstant.ERROR_CODE;
