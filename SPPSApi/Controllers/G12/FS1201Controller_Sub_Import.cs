...
namespace SPPSApi.Controllers.G03
{
    ...
    [EnableCors("any")]
    [ApiController]
    public class FS1201Controller_Sub_Import : BaseController
    {
        private readonly IWebHostEnvironment _webHostEnvironment;
        FS1201_Logic fs1201_Logic = new FS1201_Logic();
        private readonly string FunctionID = "FS1201";

        public FS1201Controller_Sub_Import(IWebHostEnvironment webHostEnvironment)
        {
        ...
        public string importSaveApi([FromBody]dynamic data)
        {
            ...
            try
            {
                ...
                fs1201_Logic.UpdateTable(importDt, vcMon);//将导入的表格数据上传
