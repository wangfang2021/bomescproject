...
namespace SPPSApi.Controllers.G12
{
    ...
    public class FS1205Controller : BaseController
    {
        ...
        public string FileExport([FromBody] dynamic data)
        {
            ...
            try
            {
                DataTable dt = fS1205_Logic.TXTSearchWeekLevelSchedule_Out(vcMonth, vcWeek, vcPlant);
                ...
                string filepath = ComFunction.generateExcelWithXlt(dt, fields, _webHostEnvironment.ContentRootPath, "FS1205_Export.xlsx", 1, loginInfo.UserId, FunctionID, true);
                if (filepath == "")
                {
                    apiResult.code = ComConstant.ERROR_CODE;
