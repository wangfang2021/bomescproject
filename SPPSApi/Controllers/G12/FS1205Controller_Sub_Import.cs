    ...
    public class FS1205Controller_Sub_Import : BaseController
    {
        ...
        public string importSaveApi([FromBody] dynamic data)
        {
            ...
            try
            {
                ...
                string strMsg = "";
                string[,] headers = new string[,] {{"对象月", "对象周", "工厂", "工程", "组别", "品番", "收容数",
