...
{
    [Route("api/FS1206_Sub_Import/[action]")]
    [EnableCors("any")]
    [ApiController]
    public class FS1206Controller_Sub_Import : BaseController
    {
        private readonly IWebHostEnvironment _webHostEnvironment;
        FS1206_Logic fs1206_Logic = new FS1206_Logic();
        private readonly string FunctionID = "FS1206";

        public FS1206Controller_Sub_Import(IWebHostEnvironment webHostEnvironment)
        {
