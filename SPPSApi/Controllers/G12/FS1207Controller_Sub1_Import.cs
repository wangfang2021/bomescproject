...
{
    [Route("api/FS1207_Sub1_Import/[action]")]
    [EnableCors("any")]
    [ApiController]
    public class FS1207Controller_Sub1_Import : BaseController
    {
        private readonly IWebHostEnvironment _webHostEnvironment;
        FS1207_Logic fs1207_Logic = new FS1207_Logic();
        private readonly string FunctionID = "FS1207";

        public FS1207Controller_Sub1_Import(IWebHostEnvironment webHostEnvironment)
        {
