...
{
    [Route("api/FS1207_Sub2_Import/[action]")]
    [EnableCors("any")]
    [ApiController]
    public class FS1207Controller_Sub2_Import : BaseController
    {
        private readonly IWebHostEnvironment _webHostEnvironment;
        FS1207_Logic fs1207_Logic = new FS1207_Logic();
        private readonly string FunctionID = "FS1207";

        public FS1207Controller_Sub2_Import(IWebHostEnvironment webHostEnvironment)
        {
        ...
        public string importSaveApi([FromBody] dynamic data)
        {
            ...
            try
            {
                ...
                fs1207_Logic.UpdateAddFZIM(importDt, loginInfo.UserId);
