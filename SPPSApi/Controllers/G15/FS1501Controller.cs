    ...
    public class FS1501Controller : BaseController
    {
        ...
        public string pageloadApi()
        {
            ...
            try
            {
                ...
                List<Object> dataList_SR = ComFunction.convertAllToResult(fs1501_Logic.getSR());//受入
                List<Object> dataList_NRBianCi = ComFunction.convertAllToResult(fs1501_Logic.getNRBianCi());//纳入便次
                res.Add("optionSR", dataList_SR);
                res.Add("optionNRBianCi", dataList_NRBianCi); 
            ...
            {
                ComMessage.GetInstance().ProcessMessage(FunctionID, "M15UE0101", ex, loginInfo.UserId);
        ...
        public string searchApi([FromBody]dynamic data)
        {
            ...
            {
                ComMessage.GetInstance().ProcessMessage(FunctionID, "M15UE0102", ex, loginInfo.UserId);
                apiResult.code = ComConstant.ERROR_CODE;
                apiResult.data = "检索失败";
                return JsonConvert.SerializeObject(apiResult, Formatting.Indented, JSON_SETTING);
            }
        ...
        public string exportApi([FromBody] dynamic data)
        {
            ...
            {
                ComMessage.GetInstance().ProcessMessage(FunctionID, "M15UE0103", ex, loginInfo.UserId);
                apiResult.code = ComConstant.ERROR_CODE;
                apiResult.data = "导出失败";
                return JsonConvert.SerializeObject(apiResult, Formatting.Indented, JSON_SETTING);
            }
        ...
        public string saveApi([FromBody]dynamic data)
        {
            ...
            {
                ComMessage.GetInstance().ProcessMessage(FunctionID, "M15UE0104", ex, loginInfo.UserId);
                apiResult.code = ComConstant.ERROR_CODE;
                apiResult.data = "保存失败";
                return JsonConvert.SerializeObject(apiResult, Formatting.Indented, JSON_SETTING);
            }
        ...
        public string delApi([FromBody]dynamic data)
        {
            ...
            {
                ComMessage.GetInstance().ProcessMessage(FunctionID, "M15UE0105", ex, loginInfo.UserId);
                apiResult.code = ComConstant.ERROR_CODE;
                apiResult.data = "删除失败";
                return JsonConvert.SerializeObject(apiResult, Formatting.Indented, JSON_SETTING);
            }
