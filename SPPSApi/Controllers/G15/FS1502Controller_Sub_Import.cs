...
namespace SPPSApi.Controllers.G15
{
    ...
    public class FS1502Controller_Sub_Import : BaseController
    {
        ...
        public string pageloadApi()
        {
            ...
            {
                ComMessage.GetInstance().ProcessMessage(FunctionID, "M15UE0211", ex, loginInfo.UserId);
        ...
        public string importSaveApi([FromBody]dynamic data)
        {
            ...
            {
                ComFunction.DeleteFolder(fileSavePath);//读取异常则，删除文件夹，全部重新上传
                ComMessage.GetInstance().ProcessMessage(FunctionID, "M15UE0212", ex, loginInfo.UserId);
                apiResult.code = ComConstant.ERROR_CODE;
