...
{
    [Route("api/FS1702_Sub_import/[action]")]
    [EnableCors("any")]
    [ApiController]
    public class FS1702Controller_Sub_import : BaseController
    {
        ...
        public string importSaveApi([FromBody]dynamic data)
        {
            ...
            {
                ComFunction.DeleteFolder(fileSavePath);//读取异常则，删除文件夹，全部重新上传
                ComMessage.GetInstance().ProcessMessage(FunctionID, "M17UE0206", ex, loginInfo.UserId);
                apiResult.code = ComConstant.ERROR_CODE;
