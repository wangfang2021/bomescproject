...
{
    [Route("api/FS1704/[action]")]
    [EnableCors("any")]
    [ApiController]
    public class FS1704Controller : BaseController
    {
        ...
        public FS1704Controller(IWebHostEnvironment webHostEnvironment)
        {
        ...
        public string searchApi([FromBody]dynamic data)
        {
            ...
            string vcNaRuPart_id = dataForm.vcNaRuPart_id;
            string vcChuHePart_id = dataForm.vcChuHePart_id;
            string vcSupplierName = dataForm.vcSupplierName;
        ...
        public string saveApi([FromBody]dynamic data)
        {
            ...
            try
            {
                ...
                fs1704_Logic.Save(listInfoData, loginInfo.UserId);
                apiResult.code = ComConstant.SUCCESS_CODE;
                apiResult.data = null;
                return JsonConvert.SerializeObject(apiResult, Formatting.Indented, JSON_SETTING);
            }
        ...
        public string delApi([FromBody]dynamic data)
        {
            ...
            try
            {
                ...
                fs1704_Logic.Del(checkedInfoData, loginInfo.UserId);
                apiResult.code = ComConstant.SUCCESS_CODE;
                apiResult.data = null;
                return JsonConvert.SerializeObject(apiResult, Formatting.Indented, JSON_SETTING);
            }
